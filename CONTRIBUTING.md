...
Thank you for considering contributing to **Jekwwer/javascript-workspace**! Contributions help me improve and maintain
the quality of this project. Whether you're fixing a bug, proposing new features, or improving documentation, your
...
2. **Clone Your Fork**:
   ...
   ```bash
   git clone https://github.com/<YOUR_USERNAME>/javascript-workspace.git
...
3. **Set Up Upstream Remote**: To keep your fork up-to-date with the original repository:
   ...
   ```bash
   git remote add upstream https://github.com/Jekwwer/javascript-workspace.git
   ```
...
The project uses a mix of manual and automated approaches: formatting is automated at the editor and pre-commit levels.

### Manual Testing

Run the following scripts to verify code quality manually:

- **npm run format:** Verifies code formatting using Prettier.
- **npm run format-fix:** Auto-formats code using Prettier.
- **npm run spell:** Checks files for typos using cspell.

### Automated Testing

Automated checks run in the editor, via pre-commit hooks mirroring the manual commands above.
...
Your contributions make **Jekwwer/javascript-workspace** better. I value your time and effort—thank you for
contributing!
